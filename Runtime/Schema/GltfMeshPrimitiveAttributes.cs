...
namespace NewtonGltf
{
    ...
    //[JsonConverter(typeof(GltfMeshPrimitiveAttributesJsonConverter))]
    public class GltfMeshPrimitiveAttributes : IDictionary<string, int>
    {
        #region Fields
        ...
        /// <summary>
        /// Create a new instance of GltfMeshPrimitiveAttributes.
        /// </summary>
        public GltfMeshPrimitiveAttributes()
        {
            _attributeDictionary = new Dictionary<string, int>();
        }

        /// <summary>
        /// Create a new instance of GltfMeshPrimitiveAttributes with dictionary.
        /// </summary>
        ...
        /// <returns></returns>
        public bool Equals(GltfMeshPrimitiveAttributes other)
        {
