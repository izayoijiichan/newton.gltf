...
namespace NewtonGltf
{
    ...
    /// <summary>
    /// gltf Exensions or Extras base.
    /// </summary>
    [Serializable]
    public abstract class GltfExBase : KeyedCollection<string, ExModel>
    {
        #region Properties
        ...
        /// <summary>
        /// Create a new instance of GltfExBase with jsonSerializerSettings.
        /// </summary>
        /// <param name="jsonSerializerSettings"></param>
        public GltfExBase(JsonSerializerSettings jsonSerializerSettings)
        {
